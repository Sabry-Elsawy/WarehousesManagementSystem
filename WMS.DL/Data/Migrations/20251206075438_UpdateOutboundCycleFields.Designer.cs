...
namespace WMS.DAL.Data.Migrations
{
    ...
    [Migration("20251206075438_UpdateOutboundCycleFields")]
    partial class UpdateOutboundCycleFields
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WMS.DAL.Entities.CycleCount", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WMS.DAL.Entities.CycleCountItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WMS.DAL.Entities.InventoryTransaction", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WMS.DAL.Picking", b =>
                {
                    ...
                    b.Property<int?>("OriginalPickingId")
                        .HasColumnType("int");
                    ...
                    b.Property<int?>("ReservedInventoryId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WMS.DAL.SO_Item", b =>
                {
                    ...
                    b.Property<int?>("OriginalSOItemId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WMS.DAL.Entities.CycleCountItem", b =>
                {
                    ...
                    b.HasOne("WMS.DAL.Entities.CycleCount", "CycleCount")
                        .WithMany("Items")
            ...
            modelBuilder.Entity("WMS.DAL.Entities.InventoryTransaction", b =>
                {
                    b.HasOne("WMS.DAL.Entities.Bin", "DestinationBin")
                        .WithMany()
                    ...
                    b.HasOne("WMS.DAL.Entities.Bin", "SourceBin")
                        .WithMany()
